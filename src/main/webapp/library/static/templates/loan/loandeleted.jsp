...
<main>
    <div class="container2">
        <h2>Loan with id: ${requestScope.loanDTO.id} has deleted</h2><br>
        <h3>Details</h3>
        <p>Loan ID: ${requestScope.loanDTO.id} </p>
        <p>Book Title: ${requestScope.loanDTO.book.title} </p>
        <p>Member Lastname: ${requestScope.loanDTO.member.lastname} </p>
